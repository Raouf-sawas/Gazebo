...
class UR5Env(gym.Env):
    ...
    def step(self,action,iter,ep):
        ...
        print(" reward = ",reward)
        print("="*30)
        if(UR5Env.p_x > 0.7 or UR5Env.p_y > 0.2 and UR5Env.p_z > 0.8 and UR5Env.p_x < 0.3 or UR5Env.p_y < -0.2 and UR5Env.p_z < 0.4 ):
            done=True
    ...
    def reset(self):
        ...
        return[ UR5Env.p_x, UR5Env.p_y, UR5Env.p_z]
